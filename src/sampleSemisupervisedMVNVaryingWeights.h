// sampleSemisupervisedMVNVaryingWeights.h
// =============================================================================
// include guard
#ifndef SAMPLESEMISUPERVISEDMVNVARYINGWEIGHTS_H
#define SAMPLESEMISUPERVISEDMVNVARYINGWEIGHTS_H
...
// =============================================================================
// sampleSemisupervisedMVNVaryingWeights function header
...
// [[Rcpp::export]]
Rcpp::List sampleSemisupervisedMVNVaryingWeights (
    arma::mat X,
    arma::uword K,
    arma::uword B,
    arma::uvec labels,
...
#endif /* SAMPLESEMISUPERVISEDMVNVARYINGWEIGHTS_H */