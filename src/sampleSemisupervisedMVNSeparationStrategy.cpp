// sampleSemisupervisedMVNSeparationStrategy.cpp
// =============================================================================
// included dependencies
# include <RcppArmadillo.h>
# include "sampleSemisupervisedMVNSeparationStrategy.h"
...
// =============================================================================
// sampleSemisupervisedMVNSeparationStrategy function implementation
...
Rcpp::List sampleSemisupervisedMVNSeparationStrategy (
  ...
  mvnSamplerSeparationStrategy my_sampler(K,
    B,
    mu_proposal_window,
    r_proposal_window,
  ...
  for(uword r = 0; r < n_iter; r++){
    ...
    // Complete the data given the current parameters (see
    // mvnSamplerSeparationStrategy); this runs for fixed (label-known)
    // items too - see mvnSamplerSeparationStrategy.h.
