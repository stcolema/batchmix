// sampleMVNSeparationStrategy.h
// =============================================================================
// include guard
#ifndef SAMPLEMVNSEPARATIONSTRATEGY_H
#define SAMPLEMVNSEPARATIONSTRATEGY_H
...
//' @title Sample mixture of multivariate normal distributions with batch effects
 ...
 //' @param eta The LKJ concentration parameter for the correlation matrix
 //' prior on each cluster's covariance; eta = 1 is uniform over the space
 //' of correlation matrices, eta > 1 shrinks correlations towards 0.
 //' @return Named list of the different quantities drawn by the sampler.
 // [[Rcpp::export]]
 Rcpp::List sampleMVNSeparationStrategy (
     arma::mat X,
     arma::uword K,
     arma::uword B,
     arma::uvec labels,
...
#endif /* SAMPLEMVNSEPARATIONSTRATEGY_H */